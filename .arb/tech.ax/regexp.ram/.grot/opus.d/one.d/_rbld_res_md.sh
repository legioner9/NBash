...
echo -e "${CYAN}--- _rbld_res_md_rnd7_0aeb0e6() $* in file://${REPO_PATH}/NBash/.arb/tech.ax/regexp.ram/.grot/opus.d/one.d/_rbld_res_md.sh ---${NORMAL}" #started functions

_rbld_res_md_rnd7_0aeb0e6() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${REPO_PATH}/NBash/.arb/tech.ax/regexp.ram/.grot/opus.d/one.d/_rbld_res_md.sh"
