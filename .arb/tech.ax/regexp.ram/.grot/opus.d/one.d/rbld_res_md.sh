...
echo -e "${CYAN}--- rbld_res_md_rnd7_d3879f3() $* in file://${REPO_PATH}/NBash/.arb/tech.ax/regexp.ram/.grot/opus.d/one.d/rbld_res_md.sh ---${NORMAL}" #started functions

rbld_res_md_rnd7_d3879f3() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${REPO_PATH}/NBash/.arb/tech.ax/regexp.ram/.grot/opus.d/one.d/rbld_res_md.sh"
