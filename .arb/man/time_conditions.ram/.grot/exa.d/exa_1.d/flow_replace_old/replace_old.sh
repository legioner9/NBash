...
filename=${REPO_PATH}/NBash/.arb/man/time_conditions.ram/.grot/exa.d/exa_1.d/flow_replace_old/replace_old.sh
...
r_dir=${REPO_PATH}/NBash/.arb/man/time_conditions.ram/.grot/exa.d/exa_1.d/flow_replace_old
