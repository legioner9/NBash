...
echo -e "${CYAN}--- rbld_res_md_rnd7_c473d5b() $* in file://${REPO_PATH}/NBash/.arb/util.ax/exec.ram/.grot/opus.d/one.d/rbld_res_md.sh ---${NORMAL}" #started functions

rbld_res_md_rnd7_c473d5b() {
