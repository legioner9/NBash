...
echo -e "${CYAN}--- _rbld_res_md_rnd7_072f09f() $* in file://${REPO_PATH}/NBash/.arb/util.ax/exec.ram/.grot/opus.d/one.d/_rbld_res_md.sh ---${NORMAL}" #started functions

_rbld_res_md_rnd7_072f09f() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${REPO_PATH}/NBash/.arb/util.ax/exec.ram/.grot/opus.d/one.d/_rbld_res_md.sh"
