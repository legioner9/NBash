...
echo -e "${CYAN}--- rbld_res_md_rnd7_dbdb3d4() $* in file://${REPO_PATH}/NBash/.arb/util.ax/exec.ram/.grot/opus.d/one.d/rbld_res_md.sh ---${NORMAL}" #started functions

rbld_res_md_rnd7_dbdb3d4() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${REPO_PATH}/NBash/.arb/util.ax/exec.ram/.grot/opus.d/one.d/rbld_res_md.sh"
