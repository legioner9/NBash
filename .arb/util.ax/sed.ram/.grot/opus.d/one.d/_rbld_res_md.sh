...
echo -e "${CYAN}--- _rbld_res_md_rnd7_ed5a974() $* in file://${REPO_PATH}/NBash/.arb/util.ax/sed.ram/.grot/opus.d/one.d/_rbld_res_md.sh ---${NORMAL}" #started functions

_rbld_res_md_rnd7_ed5a974() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${REPO_PATH}/NBash/.arb/util.ax/sed.ram/.grot/opus.d/one.d/_rbld_res_md.sh"
