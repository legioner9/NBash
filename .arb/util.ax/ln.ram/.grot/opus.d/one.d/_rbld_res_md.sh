...
echo -e "${CYAN}--- _rbld_res_md_rnd7_ddcbcbd() $* in file://${REPO_PATH}/NBash/.arb/util.ax/ln.ram/.grot/opus.d/one.d/_rbld_res_md.sh ---${NORMAL}" #started functions

_rbld_res_md_rnd7_ddcbcbd() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${REPO_PATH}/NBash/.arb/util.ax/ln.ram/.grot/opus.d/one.d/_rbld_res_md.sh"
