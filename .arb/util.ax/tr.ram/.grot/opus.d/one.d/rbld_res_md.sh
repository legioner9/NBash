...
echo -e "${CYAN}--- rbld_res_md_rnd7_27798b0() $* in file://${REPO_PATH}/NBash/.arb/util.ax/tr.ram/.grot/opus.d/one.d/rbld_res_md.sh ---${NORMAL}" #started functions

rbld_res_md_rnd7_27798b0() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${REPO_PATH}/NBash/.arb/util.ax/tr.ram/.grot/opus.d/one.d/rbld_res_md.sh"
