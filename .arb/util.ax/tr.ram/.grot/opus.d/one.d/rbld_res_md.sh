...
echo -e "${CYAN}--- rbld_res_md_rnd7_53b74de() $* in file://${REPO_PATH}/NBash/.arb/util.ax/tr.ram/.grot/opus.d/one.d/rbld_res_md.sh ---${NORMAL}" #started functions

rbld_res_md_rnd7_53b74de() {
