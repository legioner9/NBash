...
echo -e "${CYAN}--- _rbld_res_md_rnd7_c3aa029() $* in file://${REPO_PATH}/NBash/.arb/util.ax/tr.ram/.grot/opus.d/one.d/_rbld_res_md.sh ---${NORMAL}" #started functions

_rbld_res_md_rnd7_c3aa029() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${REPO_PATH}/NBash/.arb/util.ax/tr.ram/.grot/opus.d/one.d/_rbld_res_md.sh"
