...
echo -e "${CYAN}--- _rbld_res_md_rnd7_a26d271() $* in file://${REPO_PATH}/NBash/.arb/util.ax/tr.ram/.grot/opus.d/one.d/_rbld_res_md.sh ---${NORMAL}" #started functions

_rbld_res_md_rnd7_a26d271() {
