...
echo -e "${CYAN}--- _rbld_res_md_rnd7_7a94b8c() $* in file://${REPO_PATH}/NBash/.arb/util.ax/find.ram/.grot/opus.d/one.d/_rbld_res_md.sh ---${NORMAL}" #started functions

_rbld_res_md_rnd7_7a94b8c() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${REPO_PATH}/NBash/.arb/util.ax/find.ram/.grot/opus.d/one.d/_rbld_res_md.sh"
