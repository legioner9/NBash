...
echo -e "${CYAN}--- rbld_res_md_rnd7_fda4777() $* in file://${REPO_PATH}/NBash/.arb/util.ax/find.ram/.grot/opus.d/one.d/rbld_res_md.sh ---${NORMAL}" #started functions

rbld_res_md_rnd7_fda4777() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${REPO_PATH}/NBash/.arb/util.ax/find.ram/.grot/opus.d/one.d/rbld_res_md.sh"
