...
echo -e "${CYAN}--- rbld_res_md_rnd7_0e9404e() $* in file://${REPO_PATH}/NBash/.arb/util.ax/find.ram/.grot/opus.d/one.d/rbld_res_md.sh ---${NORMAL}" #started functions

rbld_res_md_rnd7_0e9404e() {
