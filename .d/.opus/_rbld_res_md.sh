...
echo -e "${CYAN}--- _rbld_res_md_rnd7_9ff7e90() $* in file://${REPO_PATH}/NBash/.d/.opus/_rbld_res_md.sh ---${NORMAL}" #started functions

_rbld_res_md_rnd7_9ff7e90() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${REPO_PATH}/NBash/.d/.opus/_rbld_res_md.sh"
